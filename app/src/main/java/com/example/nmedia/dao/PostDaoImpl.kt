...
class PostDaoImpl(private val db: SQLiteDatabase) : PostDao {
    ...
    object PostColumns {
        ...
        const val COLUMN_VIDEOLINK = "vileolink"
    ...
    private fun map(cursor: Cursor): Post {
        with(cursor) {
            return Post(
                ...
                countOfLikes = getLong(getColumnIndexOrThrow(PostColumns.COLUMN_LIKES)),
                countOfShares = getLong(getColumnIndexOrThrow(PostColumns.COLUMN_SHARES)),
